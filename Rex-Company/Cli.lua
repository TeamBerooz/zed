...
✥ از اینکه ربات رایگان سینا را به عنوان ربات منتخب برای گروه خود انتخاب کرده اید سپاس گذاریم !
...
ایمپورت https://t.me/joinchat/HYIDF01L2mFEiwfWxwETRA
...
sendText(msg.chat_id,msg.id,'`help bot in this channel:` https://t.me/BeroozTeamHelp','html')
end
end
-----------------------------------------------
if is_Owner (msg) then
...
local sina = {'چیکارش داری؟','کارتو بگو بیاد جواب میده','برو پیویش @BeroozTeamSupportBot','نیست'}
...
sendText(msg.chat_id, msg.id, '⇋ 556-231 IS ONLINE AT ANY TIME :)', 'md')
end
-------------------------------
end
------MaTaDoR Company---------.
