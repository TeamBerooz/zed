...
local keyboard = {}
keyboard.inline_keyboard = {{{text = '✪ Group Settings And Management ', callback_data = 'Menu:'..chat_id}},{{text= '✪ Close Directory Management' ,callback_data = 'Exit:'..chat_id}},{{text="✪ Our Team·s Channel",url="https://telegram.me/BeroozTeam"}}}
AnswerInline(Company.id,'settings','Group settings',chat_id,'✪ Welcome to The Group Manager·s List','Markdown',keyboard)
else
local keyboard = {}
keyboard.inline_keyboard = {{{text="✪ Our Team·s Channel",url="https://telegram.me/BeroozTeam"}}}			
...
local keyboard = {}
keyboard.inline_keyboard = {{
{text = '✪ Github',url="https://github.com/BeroozTeam"}
},{{text = '✪ Edited By',url="https://telegram.me/S_A_F_T"}
},{{text = '✪ Our Team·s Channel',url="https://telegram.me/BeroozTeam"}
...
local keyboard = {}
keyboard.inline_keyboard = {{
{text = 'گیت هاب ❂ ',url="https://github.com/BeroozTeam"}
},{{text = 'ویرایش شده توسط ❂  ',url="https://telegram.me/S_A_F_T"}
},{{text = 'چنل تیم ❂ ',url="https://telegram.me/BeroozTeam"}
